...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'pinia' | '@nuxt/icon' | 'nuxt:global-components' | 'nuxt:prefetch' | 'pinia-plugin-persistedstate'
  }
}
